          ...
          <div class="box">
            <div class="box-header">
              <div class="row">
                ...
                <div class="col-sm-2">
                  <a href="<?php echo base_url('/dashboard/Penunjang/tambah'); ?>"><button type="button" class="btn btn-success" ><i class="fa fa-plus"></i> Tambah Data</button></a>
                </div>
              </div>
            ...
            <div class="box-body">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="text-padding text-padding"> <a href="<?php echo base_url('/dashboard/Penunjang/file/'.$item->berkas); ?>"><?=$item->berkas; ?></a></td>
                  <td class="text-padding"><?=$item->deskripsi; ?></td>
                  <td class="text-padding" style="">
                    <a href="<?php echo base_url('/dashboard/Penunjang/hapus/'.$item->id_kegiatan); ?>" class="btn btn-danger btn-xs" alt="" style="margin-bottom: 10px;" onclick="return confirm('Yakin ingin menghapus data?')"><i class="fa fa-trash"></i> Hapus</a>
                    <a href="<?php echo base_url('dashboard/Penunjang/edit/'.$item->id_kegiatan); ?>"  class="btn btn-warning btn-xs editbuku" alt=""><i class=" ace-icon fa fa-pencil bigger-130"> Edit</i></a>     
                  </td>
