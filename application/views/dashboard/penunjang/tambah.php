      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form"enctype="multipart/form-data" action="<?php echo base_url('dashboard/Penunjang/add')?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Pilih Bidang</label>
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Bidang Penunjang" disabled>
                </div>
                <div class="form-group">
